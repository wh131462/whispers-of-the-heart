...
import { blogApi, api, generateExcerpt as generateExcerptFromMarkdown } from '@whispers/utils'
...
const PostEditPage: React.FC = () => {
  ...
  const handleSave = async (shouldPublish?: boolean) => {
    ...
    try {
      setSaving(true)
      const publishStatus = shouldPublish !== undefined ? shouldPublish : post.published
