...
import { Calendar, Eye, Heart, MessageCircle, Tag, Bookmark } from 'lucide-react'
      ...
      <CardFooter className="flex items-center justify-between text-sm text-muted-foreground mt-auto">
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            ...
            <span className="text-sm">{isLikeLoading ? '...' : likesCount}</span>
          </Button>
          ...
          <Button
            ...
            className="h-8 px-2 text-muted-foreground hover:text-foreground"
          >
            <Bookmark className={`w-4 h-4 mr-1 ${isBookmarked ? 'fill-current text-yellow-500' : ''}`} />
          </Button>
