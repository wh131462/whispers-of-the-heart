      ...
      >
        ...
        >
          <div className="flex items-center w-full">
            {node.icon && (
              <span className="mr-2 flex items-center">{node.icon}</span>
            )}

            <span className="flex-1 truncate">{node.name}</span>

            {selectedValue === node.id && <Check className="h-4 w-4 ml-2" />}
          </div>
        </SelectPrimitive.Item>
      </div>
    ...
    >
      ...
      >
        <div className="flex items-center">
          {selectedNode?.icon && (
            <span className="mr-2 flex items-center">{selectedNode.icon}</span>
          )}
