...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({
  ...
  if (error) {
    return (
      <div
        className={cn(
          'w-full flex items-center justify-center bg-gradient-to-br from-purple-900 to-indigo-900 rounded-lg border border-purple-700 shadow-xl',
          className
        )}
      >
  ...
  return (
    <div
      className={cn(
        'w-full bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 p-5 rounded-xl shadow-2xl border border-purple-700/50',
        className
      )}
    >
      <ReactHowler
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <Popover>
                ...
                <PopoverContent
                  className="w-auto bg-black/95 border-purple-400/40 p-3"
                  side="top"
                >
                  <div className="flex items-center gap-2">
                    <button
            ...
            <Popover>
              ...
              <PopoverContent
                className="w-auto bg-black/95 border-purple-400/40 p-2"
                side="top"
              >
