...
Define the RSS 2.0 feed capability that exposes published blog posts to RSS readers and search engines, including the API endpoint contract, channel/item structure, caching behaviour, and the web application's feed discovery and subscription entry points.
